  ...
  return (
    <div className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-[#f9f8f6]">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <h1 className="font-['ABC_Diatype',sans-serif] font-normal leading-[normal] not-italic text-[#482b22] text-[24px] text-nowrap whitespace-pre mb-8 text-center">Enter your employee code</h1>
